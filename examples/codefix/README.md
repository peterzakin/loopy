...
```
codefix/
  registry.yml                 # BaseSandbox sandbox · Coder agent · CodeTask + PROpened events
...
`registry.yml`'s `BaseSandbox` sandbox clones `octocat/Hello-World` at startup (the `repos:` field).
